...
<body>
  ...
  <main>
    ...
    <section class="section">
      ...
      <p>Expected sanitized shape when an app cookie exists: <code>app_session=&lt;redacted&gt;; cf_clearance=&lt;redacted&gt;; __cf_bm=&lt;redacted&gt;</code>. Endpoint calls require a non-Cloudflare application cookie plus Cloudflare cookies; diagnostics reports names and readiness, not values.</p>
    </section>
