...
export function updateBreadcrumbs(view, tab) {
  const labels = { overview: 'Overview', analytics: 'Analytics', logs: 'Logs', settings: 'Settings', endpoints: 'Endpoints', data: 'Data', alerts: 'Alerts', activity: 'Activity', customers: 'Customers', pending: 'Pending', transactions: 'Transactions' };
  const tabLabels = {
