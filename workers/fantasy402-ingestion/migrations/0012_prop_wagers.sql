...
CREATE INDEX IF NOT EXISTS idx_prop_wagers_captured
  ON prop_wagers(captured_at);

CREATE INDEX IF NOT EXISTS idx_prop_wagers_agent_captured
  ON prop_wagers(agent_id, captured_at);

CREATE INDEX IF NOT EXISTS idx_prop_wagers_wager_number
  ON prop_wagers(wager_number);
