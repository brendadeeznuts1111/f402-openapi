...
requireText(contents.securedSite, "Current captures may only show Cloudflare cookies", "secured HTML docs must reflect current observed login flow");
  ...
  JSON.stringify(
    {
      ...
      checks: [
        ...
        "bearer plus Cloudflare-cookie-only auth",
